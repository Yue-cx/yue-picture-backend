...
import com.yue.yuepicturebackend.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 获取加密后的密码字符串
     *
     * @param userPassword 原始明文密码字符串
     * @return
     */
    @Override
    public String getEncryptedPassword(String userPassword) {
        // 加密，混淆密码
        final String SALT = "yuepicture";
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        if (currentUser == null || currentUser.getId() == null) {
            log.info("getLoginUser error, user not login");
